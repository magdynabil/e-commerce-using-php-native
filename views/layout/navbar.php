                    ...
                    <div class="header-bottom-right">
                        ...
                        <div class="header-currency">
                            ...
                            if (isset($_SESSION['user'])) { ?>
                                <span class="digit ">
                                    <img class="rounded-circle" width="45px" height="45px" src="../assets/img/users/<?= $_SESSION['user']->image ?>">
                                    <?= $_SESSION['user']->name; ?> <i class="ti-angle-down"></i></span>
                                <div class="dollar-submenu">
                                    <ul>
                                        <li><a href="../routes/web.php?profile=true">Profile</a></li>
